...
APPS_DIR = BASE_DIR / "everdries_ad_generator"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///everdries_ad_generator",
    ),
}
...
MIGRATION_MODULES = {"sites": "everdries_ad_generator.contrib.sites.migrations"}
...
ACCOUNT_FORMS = {"signup": "everdries_ad_generator.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "everdries_ad_generator.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "everdries_ad_generator.users.forms.UserSocialSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/providers/google/index.html
